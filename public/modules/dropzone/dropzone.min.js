...
var Emitter = function () {
    ...
    Dropzone = function () {
        ...
        return _inherits(C, Emitter), _createClass(C, null, [{
            ...
            value: function () {
                var s = this;
                if ("form" === this.element.tagName && this.element.setAttribute("enctype", "multipart/form-data"), this.element.classList.contains("dropzone") && !this.element.querySelector(".dz-message") && this.element.appendChild(C.createElement('<div class="dz-default dz-message"><div class="dz-button" type="button">'.concat(this.options.dictDefaultMessage, "</div></div>"))), this.clickableElements.length) {
                    ! function l() {
