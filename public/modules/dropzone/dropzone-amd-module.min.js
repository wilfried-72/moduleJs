    ...
    var c = function () {
        ...
        d = function () {
            ...
            return function (e, t) {
                        ...
                        addedfile: function (t) {
                            ...
                            if (this.element === this.previewsContainer && this.element.classList.add("dz-started"), this.previewsContainer) {
                                ...
                                var s = !0,
                                    ...
                                    c = void 0;
                                try {
                                    for (var d, h = t.previewElement.querySelectorAll("[data-dz-size]")[Symbol.iterator](); !(s = (d = h.next()).done); s = !0)(l = d.value).innerHTML = this.filesize(t.size)
                                } catch (e) {
                                    u = !0, c = e
                                } finally {
                                    try {
                ...
                value: function () {
                    var s = this;
                    if ("form" === this.element.tagName && this.element.setAttribute("enctype", "multipart/form-data"), this.element.classList.contains("dropzone") && !this.element.querySelector(".dz-message") && this.element.appendChild(z.createElement('<div class="dz-default dz-message"><div class="dz-button" type="button">'.concat(this.options.dictDefaultMessage, "</div></div>"))), this.clickableElements.length) {
                        ! function l() {
                ...
                value: function (e, s) {
                    function t(t) {
                        return e = console, n = "log", i = function (e) {
                            return e.log(t)
